...
class Bot(commands.AutoShardedBot):
    ...
    async def on_ready(self):
        ...
        print(f'{c[4]}----------------------')
        print(f'HoHoBot is online and in {amount} servers!')
...
#Cog/Bot Control commands don't work due to insufficient intents (this is on purpose)
...
async def status_task():
    ...
    while True:
        ...
        await bot.change_presence(
            activity=discord.Game(name="Christmas is near!")
            )
        await asyncio.sleep(120)
        await bot.change_presence(
        ...
        await asyncio.sleep(120)
        await bot.change_presence(
            activity=discord.Game(name="Kinda cold innit?")
            )
        await asyncio.sleep(120)
        await bot.change_presence(
        ...
        await asyncio.sleep(120)
        await bot.change_presence(
            activity=discord.Game(name="drinking Hot Chocolate")
            )
        await asyncio.sleep(120)
        await bot.change_presence(
            activity=discord.Game(name="eating Melomakarona")
            )
        await asyncio.sleep(120)
